...
button_cadastro_cliente = Button(janela_principal, image=imagem_cadastro_cliente, command=criar_tela_cliente)
button_cadastro_cliente.place(x=340, y=130)
label_cliente = Label(janela_principal,text="Adicionar Cliente",bg="#3c6474",fg='white', font= "Arial 8 bold")
